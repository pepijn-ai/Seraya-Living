  ...
  if (sticky) {
    return (
      <div className="fixed bottom-0 left-0 right-0 z-40 relative">
        {inner}
        <a
          href="https://wa.me/13322841002?text=Hi%2C%20I%27m%20interested%20in%20Seraya%20Living"
          target="_blank"
          rel="noopener noreferrer"
          aria-label="Chat on WhatsApp"
          className="md:hidden absolute right-4 top-1/2 -translate-y-1/2 w-12 h-12 flex items-center justify-center rounded-full bg-brand-heading shadow-lg hover:scale-110 transition-transform duration-200"
          style={{ zIndex: 60 }}
        >
