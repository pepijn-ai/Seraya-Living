...
const USPs = [
  ...
  },
  {
    ...
    body: "Utilities, high-speed WiFi, and regular housekeeping can all be arranged by us and woven into a single monthly rate — or you handle them yourself. Either way, your dedicated concierge is on hand whenever you need them.",
